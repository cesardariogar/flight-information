package com.example.FlightInformation.mapper;
...
public class TestOpenSkyStatesDeserializer {
    ...
    public void testInvalidDeser() throws IOException {
        ...
        sm.addDeserializer(PlaneStates.class, new OpenSkyStatesDeserializer());
        mapper.registerModule(sm);

        mapper.readValue(invalidJson, PlaneStates.class);
    }
    ...
    public void testInvalidDeser2() throws IOException {
        ...
        mapper.readValue("", PlaneStates.class);
    }
    ...
    public void testInvalidDeser3() throws IOException {
        ...
        PlaneStates states = mapper.readValue("{}", PlaneStates.class);
        assertEquals(0, states.getTime());
        assertNull(states.getStateVectors());

        states = mapper.readValue("null", PlaneStates.class);
        assertNull(states);
    }
    ...
    public void testDeser() throws IOException {
        ...
        PlaneStates states = mapper.readValue(validJson, PlaneStates.class);
        assertEquals("Correct Time", 1002, states.getTime());
        assertEquals("Number states", 6, states.getStateVectors().size());

        // possible cases for state vectors
        Iterator<StateVector> statesIt = states.getStateVectors().iterator();
    ...
    public void testDeserSpeed() throws IOException {
        ...
        for (long i = 0; i < count; i++) {
            mapper.readValue(validJson, PlaneStates.class);
        }
