...
public class StateVector implements Serializable {
    ...
    public StateVector(Double geoAltitude,
                       Double longitude,
                       Double latitude,
                       Double velocity,
                       Double heading,
    ...
    public StateVector(String icao24, String callsign, String originCountry, long timePosition, long lastContact, Double longitude, Double latitude, Double baroAltitude, Boolean onGround, Double velocity, Double trueTrack, Double verticalRate, Double geoAltitude, String squawk, Boolean spi, Integer positionSource) {
    }
